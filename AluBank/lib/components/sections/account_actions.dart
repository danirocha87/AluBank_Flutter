...
class _AccountActionsContent extends StatelessWidget {
  final Icon icon;
  final String text;
  // aqui era pra dar certo usar o required - required this.icon
  const _AccountActionsContent({Key key, this.icon, this.text})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Container(
      //aqui eu coloquei uma largura fixa para meu card
      width: 70,
      child: Column(
        children: [
          Padding(
